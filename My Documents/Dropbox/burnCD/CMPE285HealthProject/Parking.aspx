    ...
    <div class="content">
        <div class="wrap">
            ...
            <div class="content-menu-grid">
                ...
                <br />
                <br />
                <asp:Label ID="parkingdisable_label" runat="server" Text="Total Parking Slots for disabled:       " Visible="False" Font-Bold="True" Font-Size="Large" ForeColor="Black"></asp:Label>
