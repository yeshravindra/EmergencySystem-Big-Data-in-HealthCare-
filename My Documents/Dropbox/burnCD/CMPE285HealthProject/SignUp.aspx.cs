    ...
    public partial class SignUp : System.Web.UI.Page
    {
        ...
        protected void submit_button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string from_mail = "instahealthplus@gmail.com";
                    string subject = "Registration Successful";
                    string body = "Thank you for your registration with InstaHealth. This is to confirm that you have successfully registered with us. We look forward to help you in case of any medical emergencies in future.";
        ...
        public string SendMail(string toList, string from, string subject, string body)
        {
            ...
            try
            {
                ...
                smtpClient.Credentials = new System.Net.NetworkCredential("instahealthplus", "cmpe285cmpe285");
